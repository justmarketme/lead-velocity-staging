...
Step 2 — Current Leads: Provider, monthly spend, CPL, and conversion rate.
Step 3 — Budget & Capacity: Monthly lead spend, desired leads per week, max capacity, team size.
Step 4 — Target Market: Product focus (life/vehicle/commercial), geography, ideal client.
Step 5 — Systems & Process: CRM usage, speed-to-contact, follow-up process.
Step 6 — Goals & Targets: Monthly sales target, growth goals.
`;
