...
DROP TABLE IF EXISTS public.ai_call_requests CASCADE;
...
DROP TABLE IF EXISTS public.whatsapp_history CASCADE;
...
DROP FUNCTION IF EXISTS public.handle_new_broker CASCADE;
