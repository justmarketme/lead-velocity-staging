        ...
        <div className="space-y-6 animate-in fade-in duration-500 h-[calc(100vh-100px)] flex flex-col font-sans">
            ...
            <div className="flex flex-1 overflow-hidden gap-0">
                ...
                <div
                    ...
                    className="w-1.5 flex-shrink-0 cursor-col-resize bg-white/5 hover:bg-green-500/40 active:bg-green-500/60 transition-colors duration-150 relative group"
                    title="Drag to resize"
                >
                    <div className="absolute inset-y-0 -left-1 -right-1" />
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <div className="w-0.5 h-3 bg-green-400/60 rounded-full" />
                        <div className="w-0.5 h-3 bg-green-400/60 rounded-full" />
                        <div className="w-0.5 h-3 bg-green-400/60 rounded-full" />
                    </div>
                </div>
