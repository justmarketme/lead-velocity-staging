    ...
    const handleBrokerSelect = (broker: any) => {
        ...
        if (leads <= 6) {
            ...
            newContractData = {
                ...
                termsText: "This Agreement is for a fixed term of thirty (30) calendar days commencing on the Effective Date ('Pilot Period'). The Service Fee of R6,000 is payable in full upfront prior to campaign commencement. Lead Velocity guarantees delivery of 6 qualified leads within the Pilot Period and shall replace, at no additional cost, any lead that does not meet the agreed qualification criteria, provided the dispute is raised in writing within 48 Business Hours of delivery. At the conclusion of the Pilot Period, this Agreement terminates automatically unless the Client elects to upgrade to an ongoing service tier.",
                commissionText: "In addition to the once-off Service Fee, the Client agrees to pay Lead Velocity a commission of ten percent (10%) of the gross first-year premium value of any insurance policy sold as a direct or indirect result of Lead Velocity's lead generation efforts. This commission obligation applies to all policies sold on leads delivered during the Pilot Period and shall remain in effect for twenty-four (24) months following delivery of the relevant lead.",
                pilotEligibilityText: "This Promotional Pilot Plan is a once-off introductory offer available exclusively to first-time clients of Lead Velocity. It is not available to existing or returning clients and may not be combined with any other offer. Upon completion of the Pilot Period, the Client may apply to join an ongoing service tier (Bronze, Silver, or Gold). Standard tier pricing and terms will apply to any subsequent engagement.",
                renewalText: "Upon conclusion of the Pilot Period, the Client may elect to continue with a Bronze, Silver, or Gold ongoing service tier. Lead Velocity will provide a data-driven tier recommendation based on Pilot Period performance. There is no obligation on the Client to continue after the Pilot Period. Standard month-to-month terms will apply to any ongoing tier.",
            ...
            newContractData = {
                ...newContractData,
                subtitle: "Bronze Tier — Where We Prove Consistency",
                serviceFee: "R8,500 per month (payable weekly or monthly in advance)",
                leadTarget: "± 17 Qualified Leads per Month",
                scopeText: "Lead Velocity shall provide qualified lead generation services targeting B2B decision-makers in the Client's specified sectors and geographic focus areas. Leads are delivered on a weekly schedule. The Client may elect weekly or monthly advance payment, as agreed in writing. A minimum engagement of six (6) months is strongly recommended to allow sufficient data to assess and optimise campaign performance.",
                commissionText: "In addition to the monthly Service Fee, the Client agrees to pay Lead Velocity a commission of nine percent (9%) of the gross first-year premium value of any insurance policy sold as a direct or indirect result of Lead Velocity's lead generation efforts. This commission obligation applies to all placed policies on leads delivered under this Agreement, including referrals originating from such leads, and survives termination of this Agreement for twenty-four (24) months from the date of last lead delivery.",
                pilotEligibilityText: "The Bronze tier is Lead Velocity's standard entry-level ongoing service. This Agreement is month-to-month with no lock-in period beyond the one calendar month notice requirement. The Client may upgrade to the Silver or Gold tier at the start of any billing cycle upon written request.",
                renewalText: "This Agreement continues on a month-to-month basis. Either Party may cancel by giving one (1) calendar month's written notice, effective at the end of the then-current Delivery Cycle. Lead Velocity recommends a minimum six (6) month engagement to ensure statistical validity of campaign data and to allow for full optimisation of targeting parameters. Upgrades to Silver or Gold tiers are available at any time.",
            ...
            newContractData = {
                ...newContractData,
                subtitle: "Silver Tier — Where Results Become Predictable",
                serviceFee: "R10,500 per month (payable weekly or monthly in advance)",
                leadTarget: "± 23–26 Qualified Leads per Month",
                scopeText: "Lead Velocity shall provide higher-volume qualified lead generation services with bi-weekly performance reviews, ongoing messaging optimisation, and priority lead delivery targeting B2B decision-makers in the Client's specified sectors. The Client may elect weekly or monthly advance payment, as agreed in writing. A minimum engagement of six (6) months is strongly recommended to allow sufficient campaign optimisation and conversion data.",
                commissionText: "In addition to the monthly Service Fee, the Client agrees to pay Lead Velocity a commission of eight percent (8%) of the gross first-year premium value of any insurance policy sold as a direct or indirect result of Lead Velocity's lead generation efforts. This commission obligation applies to all placed policies on leads delivered under this Agreement, including referrals originating from such leads, and survives termination of this Agreement for twenty-four (24) months from the date of last lead delivery.",
                pilotEligibilityText: "The Silver tier is Lead Velocity's recommended ongoing service for brokers who have established baseline conversion data and are ready for predictable, scalable lead flow. This Agreement is month-to-month with no lock-in beyond the one calendar month notice requirement. Upgrade to the Gold tier is available upon written request.",
                renewalText: "This Agreement continues on a month-to-month basis. Either Party may cancel by giving one (1) calendar month's written notice, effective at the end of the then-current Delivery Cycle. Lead Velocity recommends a minimum six (6) month engagement to allow full optimisation of campaign targeting, messaging, and lead quality filters. Upgrades to the Gold tier are available at any time.",
                termsText: "This Agreement commences on the Effective Date and continues on a month-to-month basis until terminated in accordance with clause 12. The Service Fee is payable in advance of each Delivery Cycle (weekly or monthly as agreed). Bi-weekly performance reviews are scheduled to optimise lead quality and targeting. Lead Velocity guarantees replacement of any lead that does not meet the agreed qualification criteria, provided the dispute is raised in writing within 48 Business Hours of delivery.",
                terminationText: "Either Party may terminate this Agreement by giving not less than one (1) calendar month's written notice to the other Party. Notice must be delivered to the other Party's registered email address and takes effect from the date of confirmed receipt. Termination is effective at the end of the Delivery Cycle following expiry of the notice period. Upon termination: (i) all fees for leads already delivered are immediately due; (ii) clauses on confidentiality, commissions, intellectual property, non-solicitation, and liability survive termination.",
            };
        } else {
            tierLabel = "Gold";
            newContractData = {
                ...newContractData,
                subtitle: "Gold Tier — Where We Operate as Your Revenue Partner",
                serviceFee: "R16,500+ per month (payable weekly or monthly in advance)",
                leadTarget: "33–40+ Qualified Leads per Month",
                scopeText: "Lead Velocity shall operate as a full revenue partner, providing maximum-volume qualified lead generation with advanced targeting filters, dedicated campaign management, and ongoing conversion strategy support targeting B2B decision-makers across the Client's specified sectors and geographic areas. The Client may elect weekly or monthly advance payment, as agreed in writing. A minimum engagement of six (6) months is strongly recommended to achieve full market penetration and campaign optimisation.",
                commissionText: "In addition to the monthly Service Fee, the Client agrees to pay Lead Velocity a commission of six percent (6%) of the gross first-year premium value of any insurance policy sold as a direct or indirect result of Lead Velocity's lead generation efforts. This commission obligation applies to all placed policies on leads delivered under this Agreement, including referrals originating from such leads, and survives termination of this Agreement for twenty-four (24) months from the date of last lead delivery.",
                pilotEligibilityText: "The Gold tier is Lead Velocity's premium revenue partnership offering. This Agreement is month-to-month with no lock-in beyond the one calendar month notice requirement. Clients on the Gold tier receive dedicated campaign management, advanced lead filters, and priority access to new lead sources. Exclusivity arrangements within defined geographic or sector areas may be negotiated separately in writing.",
                renewalText: "This Agreement continues on a month-to-month basis. Either Party may cancel by giving one (1) calendar month's written notice, effective at the end of the then-current Delivery Cycle. Lead Velocity recommends a minimum six (6) month engagement to allow full market penetration and optimisation of the campaign strategy. Sector or geographic exclusivity may be considered after six (6) months of consistent performance, subject to a separate written addendum.",
                termsText: "This Agreement commences on the Effective Date and continues on a month-to-month basis until terminated in accordance with clause 12. The Service Fee is payable in advance of each Delivery Cycle (weekly or monthly as agreed). Weekly performance check-ins and a monthly strategy session are included. Lead Velocity guarantees replacement of any lead that does not meet the agreed qualification criteria, provided the dispute is raised in writing within 48 Business Hours of delivery.",
                terminationText: "Either Party may terminate this Agreement by giving not less than one (1) calendar month's written notice to the other Party. Notice must be delivered to the other Party's registered email address and takes effect from the date of confirmed receipt. Termination is effective at the end of the Delivery Cycle following expiry of the notice period. Upon termination: (i) all fees for leads already delivered are immediately due; (ii) clauses on confidentiality, commissions, intellectual property, non-solicitation, and liability survive termination.",
            };
        }
